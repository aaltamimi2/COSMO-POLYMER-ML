...
# 1) Grouped CV holding out entire polymers (saves CSV + figures to results/common-solvents/cv)
...
# 2) Train an ensemble and rank candidate experiments (CSV + figures to results/common-solvents/active_learning)
