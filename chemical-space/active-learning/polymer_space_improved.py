"""
Polymer chemical-space sandbox (SMILES-only) - IMPROVED VERSION

Key improvements:
  ✅ Reduced fingerprint size (512 bits) - much faster, sufficient for 20 polymers
  ✅ PCA pre-reduction before UMAP (standard best practice)
  ✅ Cosine metric instead of Jaccard (faster for normalized data)
  ✅ Better label positioning with adjustText
  ✅ Variance explained shown on PCA plot
  ✅ Interactive Plotly version option
  ✅ Better color scheme and styling

Install:
  python -m pip install --user numpy pandas matplotlib scikit-learn umap-learn rdkit-pypi adjustText plotly
Run:
  python polymer_space_improved.py
"""
